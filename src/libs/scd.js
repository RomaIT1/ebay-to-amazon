...
function init() {
    ...
    // }
    var videoEl_width = /** @type {string} */ videoEl.videoWidth;
    var videoEl_height = /** @type {string} */ videoEl.videoHeight;
